...
function createTree(arrName, startNode, openNode) {
	...
	if (nodes.length > 0) {
		...
		if (startNode !=0) {
			...
			document.write("<a onmouseover=\"window.status='" + nodeValues[2] + "';return true;\" onmouseout=\"window.status=' ';return true;\"><img src=\"img/folderopen.gif\" align=\"absbottom\" alt=\"\" />" + nodeValues[2] + "</a><br />");
		} else document.write("<img src=\"img/base.gif\" align=\"absbottom\" alt=\"\" />Select Area<br />");
...
function addNode(parentNode, recursedNodes) {
	for (var i = 0; i < nodes.length; i++) {
		...
		if (nodeValues[1] == parentNode) {
			...
			document.write("<img id=\"icon" + nodeValues[0] + "\" src=\"" + nodeValues[4] + "\" align=\"absbottom\" alt=\"Page\" />");
			}
			// Write out node name
