...
if os.path.exists(sys.argv[1]) :
	...
	if sys.argv[2] == "1" :
		ser.write('\x7E\x32\x35\x30\x32\x34\x36\x39\x30\x30\x30\x30\x30\x46\x44\x41\x34\x0D')
	elif sys.argv[2] == "2" :
		ser.write('\x7E\x32\x35\x30\x33\x34\x36\x39\x30\x30\x30\x30\x30\x46\x44\x41\x33\x0D')
	elif sys.argv[2] == "3" :
		ser.write('\x7E\x32\x35\x30\x32\x34\x36\x39\x30\x30\x30\x30\x30\x46\x44\x41\x34\x0D')
	elif sys.argv[2] == "4" :
		ser.write('\x7E\x32\x35\x30\x32\x34\x36\x39\x30\x30\x30\x30\x30\x46\x44\x41\x34\x0D')
